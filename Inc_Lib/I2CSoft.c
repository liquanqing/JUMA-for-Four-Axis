...
i2c_t i2c_single_write( uint8_t chSlaveAddr,
                        uint8_t chRegAddr,
                        uint8_t chByte)
{
    if(!i2c_start()){
...
//Param:  uint8_t chByte
//Return: i2c_t  I2C_ERR : 失败   I2C_SUCCESS : 成功
i2c_t i2c_single_write16( uint8_t chSlaveAddr,
                        uint16_t hwRegAddr,
                        uint8_t chByte)
{
    if(!i2c_start()){
...
//Param:  uint8_t chLen
//Return: i2c_t  I2C_ERR : 失败   I2C_SUCCESS : 成功
i2c_t i2c_multi_write( uint8_t chSlaveAddr,
						uint8_t chRegAddr,
						uint8_t *pBuf,
						uint16_t hwLen)
{
...
//Return: i2c_t  I2C_ERR : 失败   I2C_SUCCESS : 成功
i2c_t i2c_multi_write16( uint8_t chSlaveAddr,
						uint16_t hwRegAddr,
						uint8_t *pBuf,
						uint16_t hwLen)
{
...
//Param:  uint16_t hwLen
//Return: i2c_t
i2c_t i2c_multi_read(uint8_t chSlaveAddr,
                    uint8_t chRegAddr,
                    uint8_t *pBuf,
                    uint16_t hwLen)
{
...
//Param:  uint16_t hwLen
//Return: i2c_t
i2c_t i2c_multi_read16(uint8_t chSlaveAddr,
                    uint16_t hwRegAddr,
                    uint8_t *pBuf,
                    uint16_t hwLen)
{
